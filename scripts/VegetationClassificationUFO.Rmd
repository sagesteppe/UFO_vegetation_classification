...
```{r make waffle charts of changes in vegetation, eval = T,  echo = F,  fig.height = 7, fig.width = 3, fig.cap = "Changes in Predicted Land Cover", out.width= "50%", out.extra='style="float:left; padding:10px"'}
