...
```{r reimport data for showing flow from veg classes, echo = F, eval = T, fig.cap= "Depiction of how raster cells in the UFO are redistributed from the original sample design (lower half), to the the reclassified spatial product for the sample design (upper half)", fig.height = 6, fig.width = 6}
