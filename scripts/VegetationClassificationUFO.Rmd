...
texture_PrincComponents <- c(texture_PC[[c(1:2)]])
...
# ALTERNATIVE USING RANDOM FOREST PACKAGE
...
registerDoParallel(cl)
veg_rf_model <- randomForest(class~., data=VegClass, proximity=TRUE)
stopCluster(cl); remove(cl)

print(veg_rf_model)
print(importance(veg_rf_model,type = 2))
